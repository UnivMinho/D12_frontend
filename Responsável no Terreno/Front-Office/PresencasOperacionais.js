...
const variaveldois=document.getElementById("iconsecondsquarePresencaOperacionais");
variaveldois.onclick=dadossecondsquare;

const variaveltres=document.getElementById("iconthirdsquarePresencaOperacionais");
variaveltres.onclick=dadosthirdsquare;

const variavelquatro=document.getElementById("iconfourthsquarePresencaOperacionais");
variavelquatro.onclick=dadosfourthsqaure;

const variavelcinco=document.getElementById("iconfifthsquarePresencaOperacionais");
